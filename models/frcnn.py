import sys
import os
sys.path.append(os.path.abspath('/content/TOG/frcnn_utils/pytorch-faster-rcnn/lib'))
sys.path.append(os.path.abspath('/content/TOG/frcnn_utils/pytorch-faster-rcnn/tools'))
